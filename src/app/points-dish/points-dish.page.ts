...
@Component({
  selector: 'app-points-dish',
  templateUrl: './points-dish.page.html',
  styleUrls: ['./points-dish.page.scss'],
})
export class PointsDishPage implements OnInit {
  ...
  addToCart() {
      ...
      points: this.dish.points * this.quantity,
      totalPrice: this.dish.points * this.quantity
    };
    this.cartService.addToCart(cartItem);
    this.router.navigate(['/points-cart']);
  }
